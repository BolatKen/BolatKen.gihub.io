 ...
 */
    ...
    function Ie(e, t, n, r) {
        ...
        if (y || p > 1 && "string" == typeof v && !h.checkClone && qe.test(v))
        ...
        if (p && (o = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild,
        1 === i.childNodes.length && (i = o),
        o || r)) {
            for (u = (s = w.map(ge(i, "script"), Oe)).length; f < p; f++)
                l = i,
                f !== d && (l = w.clone(l, !0, !0),
                u && w.merge(s, ge(l, "script"))),
                n.call(e[f], l, f);
            if (u)
                ...
                f = 0; f < u; f++)
                    l = s[f],
                    de.test(l.type || "") && !J.access(l, "globalEval") && w.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && w._evalUrl(l.src) : m(l.textContent.replace(Le, ""), c, l))
        }
        return e
    }
    function $e(e, t, n) {
        for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && w.contains(r.ownerDocument, r) && ve(ge(r, "script")),
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    Me(e, s);
            return (a = ge(s, "script")).length > 0 && ve(a, !u && ge(e, "script")),
            s
        },
    ...
    function _e(e, t, n) {
        ...
        return (n = n || Be(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e) || (a = w.style(e, t)),
        !h.pixelBoxStyles() && We.test(a) && Fe.test(t) && (r = s.width,
        i = s.minWidth,
        o = s.maxWidth,
    ...
    !function() {
        function t() {
            if (c) {
                ...
                we.appendChild(l).appendChild(c);
    ...
    function Ze(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
            ...
            r ? ("content" === n && (u -= w.css(e, "padding" + ie[a], !0, i)),
            "margin" !== n && (u -= w.css(e, "border" + ie[a] + "Width", !0, i))) : (u += w.css(e, "padding" + ie[a], !0, i),
            "padding" !== n ? u += w.css(e, "border" + ie[a] + "Width", !0, i) : s += w.css(e, "border" + ie[a] + "Width", !0, i));
    ...
    w.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = G(t), u = Ue.test(t), l = e.style;
                if (u || (t = Je(s)),
                a = w.cssHooks[t] || w.cssHooks[s],
                void 0 === n)
                    return a && "get"in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                "string" === (o = typeof n) && (i = re.exec(n)) && i[1] && (n = se(e, t, i),
                o = "number"),
    ...
    w.each(["height", "width"], (function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !Xe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? et(e, t, r) : ae(e, Ve, (function() {
                        return et(e, t, r)
                    }
                    ))
            },
            set: function(e, n, r) {
                var i, o = Be(e), a = "border-box" === w.css(e, "boxSizing", !1, o), s = r && Ze(e, t, r, a, o);
                return a && h.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Ze(e, t, "border", !1, o) - .5)),
                s && (i = re.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                n = w.css(e, t)),
                Ke(0, n, s)
            }
        }
    ...
    w.cssHooks.marginLeft = ze(h.reliableMarginLeft, (function(e, t) {
        if (t)
            return (parseFloat(_e(e, "marginLeft")) || e.getBoundingClientRect().left - ae(e, {
                marginLeft: 0
            }, (function() {
    ...
    w.Animation = w.extend(ct, {
        tweeners: {
            "*": [function(e, t) {
                ...
                return se(n.elem, e, re.exec(t), n),
                n
            }
            ]
        },
        ...
        prefilters: [function(e, t, n) {
            var r, i, o, a, s, u, l, c, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && oe(e), v = J.get(e, "fxshow");
    ...
    w.extend(w.event, {
        trigger: function(t, n, i, o) {
            ...
            if (s = h = u = i = i || r,
            3 !== i.nodeType && 8 !== i.nodeType && !xt.test(m + w.event.triggered) && (m.indexOf(".") > -1 && (x = m.split("."),
            m = x.shift(),
            x.sort()),
            c = m.indexOf(":") < 0 && "on" + m,
            ...
            o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                ...
                return t.type = m,
                o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(y.pop(), n) || !Y(i) || c && g(i[m]) && !v(i) && ((u = i[c]) && (i[c] = null),
                w.event.triggered = m,
                t.isPropagationStopped() && h.addEventListener(m, bt),
                i[m](),
                t.isPropagationStopped() && h.removeEventListener(m, bt),
    ...
    w.parseHTML = function(e, t, n) {
        ...
        a = !n && [],
        (o = A.exec(e)) ? [t.createElement(o[1])] : (o = be([e], t, a),
